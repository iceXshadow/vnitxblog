        ...
        <div className="grid gap-4 md:grid-cols-2">
          ...
          <CardContent className="flex flex-col justify-center p-6">
            ...
            <p className="mb-4 text-muted-foreground">
              Discover how AI is transforming industries and reshaping the way we interact with technology in our daily
              lives.
            </p>
            <div className="mt-auto flex items-center gap-2">
              <div className="relative h-8 w-8 overflow-hidden rounded-full">
                <Image src="/placeholder.svg" alt="Author" width={32} height={32} className="object-cover" />
              </div>
              <div>
                <p className="text-sm font-medium">Alex Johnson</p>
                <p className="text-xs text-muted-foreground">Mar 20, 2025 · 8 min read</p>
              </div>
            </div>
          </CardContent>
        </div>
        ...
        <Card key={i} className="overflow-hidden">
          ...
          <CardContent className="p-4">
            ...
            <p className="mb-4 line-clamp-2 text-sm text-muted-foreground">
              Learn the fundamental UX design principles that can transform your digital product and enhance user
              experience.
            </p>
